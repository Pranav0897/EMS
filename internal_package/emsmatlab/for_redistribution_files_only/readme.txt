emsmatlab MATLAB Python Package
...
2. Installing the emsmatlab Package

A. Change to the directory that contains the file setup.py and the subdirectory 
emsmatlab. If you do not have write permissions, copy all its contents to a temporary 
...
3. Using the emsmatlab Package

The emsmatlab package is on your Python path. To import it into a Python script or 
session, execute:
