Packaging and Deploying matlabems
...
2. Installing the matlabems Package

A. Go to the directory that contains the file setup.py and the subdirectory matlabems. If 
...
3. Using the matlabems Package

The matlabems package is on your Python path. To import it into a Python script or 
   session, execute:
